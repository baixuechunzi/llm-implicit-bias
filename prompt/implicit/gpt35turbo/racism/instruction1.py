...
def func1():
    defaults = df.loc[df['dataset'] == 'racsim']['A'].dropna().str.lower().tolist()
    stigmas = df.loc[df['dataset'] == 'racsim']['B'].dropna().str.lower().tolist()
    attributes = df.loc[df['dataset'] == 'racsim']['C'].dropna().str.lower().tolist()
    ...
    temp_df.to_csv('../implicit_gpt35_racsim_instruction1.csv')
