...
def func1():
    ...
    attributes = df.loc[df['dataset'] == 'buddhism']['D'].dropna().str.lower().tolist()
    ...
    temp_df.to_csv('../decision_llama2chat13b_buddhism_synonym.csv')
