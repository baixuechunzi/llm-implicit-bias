...
def func1():
    ...
    attributes = df.loc[df['dataset'] == 'age']['D'].dropna().str.lower().tolist()
    ...
    temp_df.to_csv('../decision_llama2chat13b_age_synonym.csv')
